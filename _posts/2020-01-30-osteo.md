---
layout: post
title: "Predicting Osteoporosis Risk Factors"
subtitle: "Predicting Osteoporosis Risk Factors in US Adults using 2017-2018 NHANES Data in RStudio"
background: '/img/posts/osteo/1.jpg'
---

---
title: "PREDICTING RISK FACTORS OF OSTEOPOROTIC FRACTURES IN UNITED STATES ADULTS"
...
#saving data for late use
getwd()
save(dat, file="Project.RData")

#loading saved data
load('/Users/winnie/Desktop/project/finalProject.RData')
names(dat)
summary(dat)
dim(dat)
glimpse(dat)
...
![Missing data](/img/posts/sas/3.png)

#In checking the patern of the missing values, 84% of the samples are not missing any information

write.csv(dat,"/Users/winnie/Desktop/ILE/Project.csv", row.names = TRUE)
...
![Fracture vs age](/img/posts/osteo/Rplot of Fracture vs age.png)
...
![Decision Tree](/img/posts/osteo/Rplot of Decision Tree.png)
...
varImpPlot(fit_rf)
![Random Forest Important Features](/img/posts/osteo/Rplot Random Forest Important Features.png)
...
![Missclassification error of lasso and ridge](/img/posts/osteo/Rplot of Missclassification error of lasso and ridge.png)
...
![Lasso Important variables](/img/posts/osteo/Rplot Lasso Important variables.png)
...
![Random forest CV impt variables](/img/posts/osteo/Rplot Random forest CV impt variables.png)
...
![Baging imp variables](/img/posts/osteo/Rplot Bagging Important variables.png)
...
![Boosting imp variables](/img/posts/osteo/Rplot Boosting imp variables.png)
